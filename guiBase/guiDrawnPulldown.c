...
void guiDrawnPulldownDrawArrow( const DocumentRectangle *	drClip,
				int *				pRestWide,
				int *				pRestHigh,
				APP_WIDGET			w,
...
void guiInitDrawnPulldown(		AppDrawnPulldown *		adp )
    {
...
void guiCleanDrawnPulldown(		AppDrawnPulldown *		adp )
    {
...
int guiFinishDrawnPulldownInplace(	AppDrawnPulldown *	adp )
    {
    if  ( ! adp->adpInplaceDrawingSurface )
	{
...
int guiFinishDrawnPulldownPulldown(	AppDrawnPulldown *	adp )
    {
    if  ( ! adp->adpPulldownDrawingSurface )
	{
	const int	avoidFontconfig= 0;
...
void guiExposeDrawnPulldownInplace(	AppDrawnPulldown *	adp )
    {
