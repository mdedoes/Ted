/************************************************************************/
/*									*/
/*  Drawing surface GTK/GDK implementation.				*/
/*									*/
/************************************************************************/
...
DrawingSurface drawMakeDrawingSurfaceForImageAndParent(
    ...
    if  ( drawUtilGdkMakeImage( &xim, wide, high, ds->dsColors, ri, drSrc ) )
...
int drawRasterImage(		DrawingSurface			ds,
    ...
    if  ( drawUtilGdkMakeImage( &xim, pixelsWide, pixelsHigh,
						ds->dsColors, ri, drSrc ) )
...
int drawSetForegroundColor(	DrawingSurface		ds,
    ...
    if  ( drawColorRgb( &xc, ds->dsColors,
				    rgb8->rgb8Red,
				    rgb8->rgb8Green,
				    rgb8->rgb8Blue ) )
	{ LDEB(1); return -1;	}
...
#   endif
    ...
    if  ( drawHandleTextSegmentsX11( &tp, dsf, s, len,
		    drawTextSegment8X11, drawTextSegment16X11,
