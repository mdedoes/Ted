...
extern void guiMakeColorChooserInRow(
				ColorChooser *			cc,
				int				hasAutomatic,
				APP_WIDGET			row,
				int				col,
...
extern void guiMakeToggleAndColorChooserRow(
				APP_WIDGET *			pRow,
				APP_WIDGET *			pToggle,
				ColorChooser *			cc,
				int				hasAutomatic,
...
extern void guiMakeLabelAndColorChooserRow(
				APP_WIDGET *			pRow,
				APP_WIDGET *			pLabel,
				ColorChooser *			cc,
				int				hasAutomatic,
...
extern void appColorChooserColorChosen(	struct PropertyMask *	isSetMask,
					int *			pChanged,
					RGB8Color *		rgb8To,
					int *			pExplicit,
