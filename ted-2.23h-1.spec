...
Source:         ftp://ftp.nluug.nl/pub/editors/ted/ted-2.23h.src.tar.gz
...
%prep
rm -rf Ted-2.23h
zcat ${RPM_SOURCE_DIR}/ted-2.23h.src.tar.gz | tar xvf -
##
##  Build section:
##
%build
( cd Ted-2.23h && make CONFIGURE_OPTIONS=--with-GTK )
( cd Ted-2.23h && make package CONFIGURE_OPTIONS=--with-GTK )
##
##  Install section:
##
%install
...
%attr(644,root,root) /usr/share/Ted/varia/ted-2.23h.lsm
